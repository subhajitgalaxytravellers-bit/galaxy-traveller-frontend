...
export default function ScrollToTop() {
  ...
  return (
    <div
      className={`fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-50 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
        showScrollTop
    ...
    >
      ...
      >
        ...
        <ArrowUp strokeWidth={2} className="h-6 w-6 sm:h-7 sm:w-7 transition-transform duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:-translate-y-1 group-hover:text-primary" />
      </button>
    </div>
  );
}
            ...
            <AnimatePresence mode="wait">
              {filteredDestinations.length > 0 ? (
                ...
                >
                    ...
                    <motion.div key={destination._id || index} variants={itemVariants}>
                        ...
                        <Card className="group p-0 overflow-hidden border-0 card-shadow hover:hover-shadow transition-all duration-300 cursor-pointer h-full">
                            ...
                            <div className="relative overflow-hidden h-full">
                                ...
                                {/* Hover Details */}
                                <div className="absolute inset-0 bg-blur backdrop-blur-sm translate-y-full group-hover:translate-y-0 transition-transform duration-300 p-6 flex flex-col justify-center">
